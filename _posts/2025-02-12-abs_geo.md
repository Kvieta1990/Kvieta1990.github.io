...
- As of writing, we have put in the definition of gauge volume for both sample and container regarding the absorption correction. With the full Paalman-Pings type of correction, we decided to go with the rudimentary route, i.e., defining the beam size to set up the gauge volume automatically.
