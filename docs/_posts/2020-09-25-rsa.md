...
$$
\begin{equation}\begin{aligned}m^{ed} & \equiv m^{k\phi(n) + 1}\\ & \equiv m\times m^{k\phi(n)}\\ & \equiv m\times(m^{\phi(n)})^k\ (mod\ n)\end{aligned}\end{equation}
$$
...
$$
\begin{equation}\begin{aligned}m & \equiv 17639^{11613}\ mod\ 83\\ & \equiv 43^{11613}\ mod\ 83\end{aligned}\end{equation}
$$
...
$$
\begin{equation}\begin{aligned}m & \equiv 43^{51}\ mod\ 83\\ & \equiv 58\ mod\ 83\end{aligned}\end{equation}
$$
